...
object SharedManager {
    ...
    fun setSearchHistoryMode(isActivated: Boolean){
        ...
        // 쉐어드 가져오기
        val shared = MyApplication.instance.getSharedPreferences(SHARED_SEARCH_HISTORY_MODE, Context.MODE_PRIVATE)
    ...
    fun getSearchHistoryList() : MutableList<SearchData>{
        ...
        // 쉐어드 가져오기
        var shared =
            MyApplication.instance.getSharedPreferences(SHARED_SHEARCH_HISTORY, Context.MODE_PRIVATE)
        val storedSearchHistoryListString : String = shared.getString(KEY_SEARCH_HISTORY, "")!!
