...
import com.cookandroid.happycup.data.model.response.SearchData
import com.cookandroid.happycup.ui.main.view.recyclerview.ISearchHistoryRecyclerView
import com.cookandroid.happycup.ui.main.view.recyclerview.PhotoGridRecyeclerViewAdapter
import com.cookandroid.happycup.ui.main.view.recyclerview.SearchHistoryRecyclerViewAdapter
import com.cookandroid.happycup.util.Constants.TAG
import com.cookandroid.happycup.util.RESPONSE_STATUS
import com.cookandroid.happycup.util.SharedManager
import com.cookandroid.happycup.util.toSimpleString
    ...
    ISearchHistoryRecyclerView
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        search_history_mode_switch.isChecked = SharedManager.checkSearchHistoryMode()
        ...
        // 저장된 검색 기록 가져오기
        this.searchHistoryList = SharedManager.getSearchHistoryList() as ArrayList<SearchData>
        ...
        if(searchTerm!!.isNotEmpty()){              //바뀐 부분
...
//        val userInputText = newText ?: ""
        ...
        when(switch){
            search_history_mode_switch ->{
                if(isChecked == true){
                    ...
                    SharedManager.setSearchHistoryMode(isActivated = true)
                } else {
                    Log.d(TAG, "검색어 저장기능 오프")
                    SharedManager.setSearchHistoryMode(isActivated = false)
                }
            }
    ...
    override fun onClick(view: View?) {
        when(view){
            clear_search_history_buttton -> {
                ...
                SharedManager.clearSearchHistoryList()
    ...
    override fun onSearchItemDeleteClicked(position: Int) {
        ...
        // 데이터 덮어쓰기
        SharedManager.storeSearchHistoryList(this.searchHistoryList)
        // 데이터 변경 됬다고 알려줌
    ...
    private fun insertSearchTermHistory(searchTerm: String){
        ...
        if(SharedManager.checkSearchHistoryMode() == true){
            // 중복 아이템 삭제
