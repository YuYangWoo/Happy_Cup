...
import com.cookandroid.happycup.util.isJsonArray
import com.cookandroid.happycup.util.isJsonObject
            ...
            override fun intercept(chain: Interceptor.Chain): Response {
                ...
                if(response.code != 200) {
                    Handler(Looper.getMainLooper()).post {
                        Toast.makeText(
                            MyApplication.instance, "${response.code} 에러 입니다.", Toast.LENGTH_SHORT).show()
                    }
                }
                return response
            }
